(function($){
	function crateCommentInfo(obj){
		...
		var el = "<div class='comment-info'><header style='float: left;'><img src='"+obj.img+"'></header><div class='comment-right'><h3 class='kt-fc-title kt-fs16'>"+obj.replyName+"</h3>"
				+"<div class='comment-content-header kt-fs13 kt-fc-desc'><span><i class='glyphicon glyphicon-time'></i>"+obj.time+"</span>";
		
		if(typeof(obj.address) != "undefined" && obj.browse != ""){
			el =el+"<span><i class='glyphicon glyphicon-map-marker'></i>"+obj.address+"</span>";
		}
		el = el+"</div><p class='content kt-fs13 kt-fc-desc'>"+obj.content+"</p><div class='comment-content-footer kt-fs13 kt-fc-desc'><div>";
		...
		el = el + "<span class='reply-btn'>回复</span></div></div><div class='reply-list'>";
